...
body: SingleChildScrollView(
  child:   Column(children: [
    Padding(
      padding:  EdgeInsets.fromLTRB(20.r,15.r,20.r,8.r,),
      child: Row(children: [
        Icon(Icons.clear,size: 30.r,),
        Spacer(),
        ...
        Container(
          ...
          child: Center(
            child: Text("100",style: TextStyle(fontWeight: FontWeight.w900,fontSize: 17.sp,color: Colors.blueGrey.shade900),),
          ),
        ),
      ],),
    ),
    ...
    Image.asset("assets/human-brain-removebg-preview.png", width: 50.sw),
    SizedBox(height: 20.h,),
    Container(width:1 * 0.70.sw, child: Text(bloc.res?.text ?? "", style: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w900,color: Colors.blueGrey.shade700),)),
