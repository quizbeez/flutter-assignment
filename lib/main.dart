...
import 'package:flutter_home_assignment/screen/question1/question1.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<QuestionTwoBloc>(create: (context) => QuestionTwoBloc()),
      ],
      child: MaterialApp(
        navigatorKey: navigatorKey,
        home: const QuestionOneScreen(),
      ),
    );
  }
}
