...
class S implements WidgetsLocalizations {
  ...
  String get appName => "Project Setup";

  String get noInternet => "No internet connected!";
...
class $de extends S {
  ...
  @override
  String get appName => "Projectable";
...
class GeneratedLocalizationsDelegate extends LocalizationsDelegate<S> {
  ...
  List<Locale> get supportedLocales {
    return const <Locale>[
      ...
      Locale(AppConstants.languageGerman, ""),
    ];
  }
  ...
  Future<S> load(Locale locale) {
    ...
    switch (lang) {
      ...
      case AppConstants.languageGerman:
        S.current = $de();
        return SynchronousFuture<S>(S.current);
      default:
    }
